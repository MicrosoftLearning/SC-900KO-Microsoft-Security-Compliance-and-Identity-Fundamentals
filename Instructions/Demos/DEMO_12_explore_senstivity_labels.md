...
#### 데모 1부: 이 데모에서는 기존 민감도 레이블의 설정, 그리고 레이블 게시를 위한 해당 정책을 살펴봅니다.
...
#### 데모 2부:  이 단계에서는 사용자(여기서는 관리자) 측면에서 레이블을 적용하는 프로세스를 진행하고, 레이블에서 생성되는 콘텐츠 표시를 확인합니다.
